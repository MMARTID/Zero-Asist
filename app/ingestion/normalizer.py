...
- ``helpers``              – string / date / number / currency primitives
...
_PROMPT_INVOICE_RECEIVED = (
    ...
    "base imponible, cuota de IVA, tipo impositivo (%), importe total, moneda, "
...
_PROMPT_INVOICE_SENT = (
    ...
    "número de factura, fecha de emisión, base imponible, cuota de IVA, tipo impositivo (%), "
    "retención de IRPF si aplica, importe total, moneda, "
...
_PROMPT_EXPENSE_TICKET = (
    "Eres un experto contable. Analiza este ticket o justificante de gasto "
    "y extrae: nombre del establecimiento, fecha, importe total, moneda, "
    "si el IVA está incluido, concepto o descripción del gasto, "
    "forma de pago, y origen del documento. "
    "El objetivo es contabilizar este gasto como deducible. "
    "Si un campo no está presente, devuelve null. "
    "Responde únicamente con el JSON estructurado."
)
